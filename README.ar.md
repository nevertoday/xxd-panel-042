...
### فتح البنية الحقيقية كدراسة مائية قابلة لإعادة التجميع
...
> المنظور الأصلي · ٢–٥ طبقات حقيقية · مرساة ثابتة · ألوان مائية شفافة · ملاحظة تحريرية

المنظور الأصلي والبنية الحقيقية هما الدليل الوحيد. تنفصل طبقتان إلى خمس طبقات كاملة ذات معنى على المحاور الحقيقية حول مرساة ثابتة، مع حفظ هوية تكفي لإعادة تجميع الموضوع ذهنياً.
...
- **الارتباط بالمصدر:** فتح البنية الحقيقية كدراسة مائية قابلة لإعادة التجميع
- **بصمة الأسلوب:** المنظور الأصلي · ٢–٥ طبقات حقيقية · مرساة ثابتة · ألوان مائية شفافة · ملاحظة تحريرية
...
| --- | --- | --- |
| `top-bottom` | لوحة نهائية أكدها المستخدم | توليد كامل واحد: المصدر عالي الوفاء في الأعلى وتصميم 042 في الأسفل، نحو 50/50 |
| `left-right` | لوحة نهائية أكدها المستخدم | توليد كامل واحد: المصدر عالي الوفاء يساراً وتصميم 042 يميناً، نحو 50/50 |
| `design-only` | لوحة نهائية أكدها المستخدم | يملأ تصميم 042 اللوحة ولا تظهر صورة المصدر |
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-042`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/042-source.md) · [توجيه الإنتاج الإنجليزي](references/xxd-panel-042-prompt.en.md) · [توجيه الإنتاج الصيني](references/xxd-panel-042-prompt.zh-CN.md)
...
<div align="center" dir="rtl"><strong>يكشف التفكيك كيف يتماسك الموضوع، لا كيف يمكن تحطيمه.</strong></div>
